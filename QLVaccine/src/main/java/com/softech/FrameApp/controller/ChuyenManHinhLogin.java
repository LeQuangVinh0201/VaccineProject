...
import com.softech.FrameApp.ui.Login_Register.RegisterUser;
 ...
 * @author leduc
 */
public class ChuyenManHinhLogin {
    private JPanel root;
    private String kindSelected = "";

    private List<DanhMucBean> listItem = null;
    
    public ChuyenManHinhLogin(JPanel jpnRoot) {
        this.root = jpnRoot;
    }
